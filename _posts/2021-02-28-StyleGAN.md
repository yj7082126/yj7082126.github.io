...
* Stochastic variation
	* Stochastic factors (ex : hair placement, freckles) can be randomized using per-pixel noise after convolution
	* Previous : network had to invent way to generate spatially-varying pseudo

> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk4MTI0Njk1LC05MTQ5MTE3MjIsLTM4OT
I2OTE0NCwxMzQwMDUyNTExLC0xOTQ2Njg0NTg2LC00NDM5MjI2
Nl19
-->