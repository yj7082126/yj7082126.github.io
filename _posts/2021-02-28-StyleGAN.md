...
* 지금까지 존재해 온 생성적 적대 모델 (GAN)을 사용한 얼굴 이미지 합성 기술들은 해상도와 전반적인 질에 있어서 가파른 발전을 보여 왔지만, 그 합성의 세부 과정들 및 잠재 공간 (Latent Space) 은 여전히 미지의 영역으로 남겨져 왔습니다.
	* 또한, 이로 인해 얼굴 합성 시 성별이나 연령 등, 사람의 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUwNjQ2OTAwNCw5ODMwOTY1MzAsLTExNj
UyMjU2ODgsLTE3MjIzODY5MTUsLTI1NjE2MDU2MywtOTE0OTEx
NzIyLC0zODkyNjkxNDQsMTM0MDA1MjUxMSwtMTk0NjY4NDU4Ni
wtNDQzOTIyNjZdfQ==
-->