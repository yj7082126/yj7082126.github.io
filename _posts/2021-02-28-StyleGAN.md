...
* While generative adversarial networks (GAN) based image generation has met rapid improvement in resolution and quality, the process remains unknown.
	* Properties of latent space and other aspects of the image synthesis process is still lacking.
...
> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc2MzE3MTc0OF19
-->