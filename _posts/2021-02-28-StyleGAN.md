...
* Perceptual path length : weighted difference between VGG16 embeddings.
	* Given $$z_1, z_2$$ from input latent space, $$t \ Uniform(0,1)$$, $$G$$ as the generator, and $$d(.,.)$$ as the perceptual difference between two generated images, $$l_{Z} = $$

> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbODY5NzQxMjg2LC0xNzIyMzg2OTE1LC0yNT
YxNjA1NjMsLTkxNDkxMTcyMiwtMzg5MjY5MTQ0LDEzNDAwNTI1
MTEsLTE5NDY2ODQ1ODYsLTQ0MzkyMjY2XX0=
-->