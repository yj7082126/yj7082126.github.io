...
* Instead of directly injecting the latent code $$\mathbb{z} \in \mathcal{Z}$$, the paper maps the latent code to intermediate late


> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNjY5OTgwMzIsMTM0MDA1MjUxMSwtMT
k0NjY4NDU4NiwtNDQzOTIyNjZdfQ==
-->