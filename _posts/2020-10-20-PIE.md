...
* RigNet을 통하여 재구성된 $\theta_w$의 non-semantic component와, $\theta_w$의 semantic component를 합친 결과로 이미지를 구성시, 원래 StyleGAN 이미지 $I\_w$와 같아야 한다.

$E_{invariance}(w) = \lambda_{invariance}\mathbb{E}_v[\ell(I, [\theta^{\bar{\tau}}_{RigNet(w, \theta^{\tau}_v)}, \theta^{\tau}_I])]$

### Face Recognition
* VGG-Face에서 사람이 얼굴 인지와 관련된 feature들을 사용하여 Face Recog
$\ell_{recog}(I', v) = \| \Psi(I') - \Psi(I\_v)\|^2\_F$
$E\_{recognition} = \lambda\_{r\_w}\ell\_{recog}(I, w) + \lambda\_{r_{w}}$

> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDU2MDQwMDM3LDEyMzg5MjA1MDUsOTY3Nj
ExNzQ2LDE1NzQ0MDE0MCwtMTM1OTg5MTA4LC05Njg3MDgxNDgs
MTE0NzY3NzAxMywtOTY4NzA4MTQ4LC05MjA2NTkxOTEsODU3Mz
